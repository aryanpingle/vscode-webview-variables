"use strict";
/* This file is automatically generated by src/create-index.js */
Object.defineProperty(exports, "__esModule", { value: true });
exports.VscodeColors = void 0;
 ...
 */
function createCSSVariable(variableName) {
    var fallbacks = [];
    ...
    if (fallbacks === undefined || fallbacks.length === 0)
        return "var(".concat(variableName, ")");
    var firstConstantIdx = -1;
    ...
    for (var i = endOfValidFallbacks - 1; i >= 0; --i) {
        // Every element we encounter will be a valid CSS variable name
        var name_1 = fallbacks[i];
        fallbackString = "var(".concat(name_1, ", ").concat(fallbackString, ")");
    }
    return "var(".concat(variableName, ", ").concat(fallbackString, ")");
}
